...
//Map inputs to outputs -> The Process
    ...
    do{
        ...
        if (d1==d2==d3||d1==d2==d4||d1==d2==d5||d2==d3==d4||d2==d3==d5||d1==d4==d5||d2==d4==d5||d1==d3==d5||d1==d2==d5){
        ...
        if (d1==d2==d3==d4||d1==d2==d3==d5||d1==d2==d4==d5||d1==d3==d4==d5||d2==d3==d4==d5){
            ...
            else if (d1==d2==d3==d5){//check quad 2
                t9=d1+d2+d3+d5;
            }
            else if (d1==d2==d4==d5){//check quad 3
                t9=d1+d2+d4+d5;
            }
            else if (d1==d3==d4==d5){//check quad 4
                t9=d1+d3+d4+d5;
            }
            else if (d2==d3==d4==d5){//check quad 5
                t9=d2+d3+d4+d5;
            } 
            else
                t9=0;
        ...
        if (d1==d2==d3||d1==d2==d4||d1==d2==d5||d2==d3==d4||d2==d3==d5||d1==d4==d5||d2==d4==d5){
            if (d1==d2==d3){
        ...
        //Check for small straight. Sum of 1-4=10, Sum of 2-5=14. Output smstr
        if(     d1+d2+d3+d4==10||d1+d2+d3+d4==14||d1+d2+d3+d4==18||
                d1+d2+d3+d5==10||d1+d2+d3+d5==14||d1+d2+d3+d5==18||
                d1+d2+d4+d5==10||d1+d2+d4+d5==14||d1+d2+d3+d5==18||
                d1+d3+d4+d5==10||d1+d3+d4+d5==14||d1+d2+d3+d5==18||
                d2+d3+d4+d5==10||d2+d3+d4+d5==14||d1+d2+d3+d5==18){
                smstr+=25;
        }
        //Check for large straight. Sum of 1-5=15. Output lgstr
        if( d1+d2+d3+d4+d5==15||d1+d2+d3+d4+d5==20){
            lgstr+=40;
        }
        ...
        cout<<fixed<<setw(54)<<left<< "10. SM Straight (Sequence of 5)(Score 30) = "<<setw(4)<<right<<"= ";
            if (s10==true){
                cout<<smstr<<endl;
            }
            else{
        ...
        cout<<fixed<<setw(54)<<left<< "11. LG Straight (Sequence of 5)(Score 40) = "<<setw(4)<<right<<"= ";
            if (s11==true){
                ...
                cout<<player1[12]<<" LOCKED"<<countY<<endl;
            }
        cout<<fixed<<setw(54)<<left<< "12. Yahtzee!= 50 Points = "<<setw(4)<<right<<"= ";
            if (s12==true){
                ...
                cout<<player1[13]<<" +"<<countY<<"00"<<endl;
            } 
        ...
        cout<<fixed<<setw(54)<<left<< "3.  Threes (2) = "<<setw(4)<<right<<"= "<<                                   player1[2]<<endl;   
