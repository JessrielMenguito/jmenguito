...
//Map inputs to outputs -> The Process
    ...
    do{
        ...
        */
        ...
        //Set value of each die across array
        number[0]=d1;
        number[1]=d2;
        number[2]=d3;
        number[3]=d4;
        ...
        */
        ...
        //Check for a house. Check triplet then check for pair.  Output t10
            if (d1==d2&&d2==d3){
                ...
                if (d2==d4){//Check if there is a pair with the remaining
                t10=25;    
                }
                else t10=0;
            }
            else if (d1==d2&&d2==d5){
                if (d3==d4){//Check if there is a pair with the remaining
                t10=25;    
                }
                else t10=0;
            }
            else if (d3==d4&&d4==d5){
                if (d1==d2){//Check if there is a pair with the remaining
                t10=25;    
                }
                else t10=0;
            }
...
*/
        ...
        cout<<fixed<<setw(54)<<left<< "3.  Threes (3) = "<<setw(4)<<right<<"= ";
            if (s3==true){
               cout<< t3<<endl;
            }
            else{
